...
@Component({
  selector: 'app-cmp-equipo-tabla',
  templateUrl: './cmp-equipo-tabla.component.html',
  styleUrls: ['./cmp-equipo-tabla.component.css']
})
export class CmpEquipoTablaComponent implements OnInit {
